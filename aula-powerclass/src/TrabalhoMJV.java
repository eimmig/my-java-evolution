...
public class TrabalhoMJV {
    ...
    public static void main(String[] args) throws IOException {
		...
		*/
        ...
        // Comparando 2 paths para saberem se são copias exatas
        ...
        // Retorna o hash do path passado
    ...
    public static void existeTamanho(Path arquivo) {
        ...
        if (arquivo.toFile().exists()) {
            ...
            // Mostra o tamanho do arquivo em caracteres;
            int size = arquivo.toString().length();
            System.out.println("O tamanho do Path do arquivo em caracteres e: " + size + " caracteres");
